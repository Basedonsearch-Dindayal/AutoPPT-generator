...
// Missing imports and function declarations
...
function validateInput(topic, slideCount, presentationStyle, audienceLevel, colorTheme) {
  ...
  if (slideCount && (isNaN(slideCount) || slideCount < 1 || slideCount > 20)) {
    errors.push('Slide count must be between 1 and 20');
  }
  return errors;
}

// Function to generate presentation outline
...
// Server startup is handled in the main server section above
